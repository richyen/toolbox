...
# sudo -u enterprisedb /usr/ppas-${PGMAJOR}/bin/pg_basebackup -xRP -h 10.228.145.74 -p5432 -D ${PGDATA}
...
# /usr/ppas-${PGMAJOR}/bin/pgbench -P 30 -T 1800 -R 600 -f ${H}/bench.sql -p5432 -U enterprisedb edb 
